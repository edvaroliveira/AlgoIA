...
$router->get('/admin/teacher-requests', 'AdminController@teacherRequests');
$router->get('/admin/teacher-requests/history', 'AdminController@teacherRequestHistory');
$router->post('/admin/teacher-requests/{id}/approve', 'AdminController@approveTeacherRequest');
$router->post('/admin/teacher-requests/{id}/reject', 'AdminController@rejectTeacherRequest');
$router->post('/admin/settings/teacher-registration', 'AdminController@toggleTeacherRegistration');
