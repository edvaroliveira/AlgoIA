-- AlgoIA - Reset completo das TABELAS do banco de TESTE HostGator
-- Data: 2026-05-23
--
-- ATENCAO: este script APAGA as tabelas do sistema no banco selecionado
-- e recria a estrutura completa do zero.
-- Use somente em ambiente de teste/homologacao.
--
-- Como usar no phpMyAdmin:
-- 1. Selecione o banco de teste no painel lateral.
-- 2. Confirme que NAO e o banco de producao.
-- 3. Execute este SQL.
--
-- Este script nao executa DROP DATABASE nem CREATE DATABASE.
...
DROP TABLE IF EXISTS `exercise_turmas`;
